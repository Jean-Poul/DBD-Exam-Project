...
public class CustomerController {
    ...
    public CustomerDTO createOrder(@RequestBody CustomerRequest customer) {
        ...
        //userServiceImpl.createUser(new UserRequest(customer.getUser().getEmail(), customer.getUser().getPassword(), customer.getUser().getPhone(), customer.getUser().getAddress().getId()));
        // userServiceImpl.createUser(new UserRequest(customer.getUser().getEmail(), customer.getUser().getPassword(), customer.getUser().getPhone()));
       ...
       // CustomerRequest customerRequest = new CustomerRequest(customer.getEmail(), customer.getPassword(), customer.getPhone(), customer.getAddressId(), customer.getFirstName(), customer.getLastName());
